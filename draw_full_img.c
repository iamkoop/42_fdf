...
/*   Updated: 2026/03/25 18:42:54 by nildruon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

t_line_data *set_coords(t_data	p1, t_data	p2)
{
	t_line_data *l_data;
...
static void draw_vertical(t_img_data *img, t_input_size input_size, t_data	**data)
{
	int x;
	int y;
...
static void draw_horizontal(t_img_data *img, t_input_size input_size, t_data	**data)
{
	int x;
	int y;
...
{
	draw_horizontal(img,input_size,data);
	draw_vertical(img,input_size,data);
}